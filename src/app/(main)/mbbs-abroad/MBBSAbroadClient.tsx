...
interface MBBSAbroadClientProps {
  initialColleges: College[]
}

export default function MBBSAbroadClient({ initialColleges }: MBBSAbroadClientProps) {
              ...
              <div key={college._id} className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition-shadow flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col grow">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span className="bg-[#EF7D31]/10 whitespace-normal text-[#EF7D31] text-xs font-medium px-2 py-1 rounded-full">
                      MBBS
                    </span>
                  </div>
